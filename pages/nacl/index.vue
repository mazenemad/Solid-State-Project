<template>
  ...
  <div class="canvas-wrapper">
    ...
    <!-- <div class="photo">
      <img src="~public/bcc-packing-density.svg" >
         </div> -->

         <button id="myImg"  class="button-74" role="button">Show Details</button>
         <img id="img" alt="nacl" style="display:none;" src="~/assets/img/nacl.png" >
...
.button-74 {
  ...
  let fcc;
    gltfLoader.load('/naclmain.glb',(gltf)=>{
      fcc=gltf.scene
      scene.add(fcc)
      fcc.position.y=-4
    })
...
const pointLight3 = new THREE.DirectionalLight( 0xffffff, 1, 100 );
const pointLight4 = new THREE.DirectionalLight( 0xffffff, 1, 100 );
const  pointLight2= new THREE.DirectionalLight( 0xffffff, 1, 100 );
