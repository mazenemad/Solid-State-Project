<template>
    ...
    <div class="canvas-wrapper">
      ...
      <button id="myImg"  class="button-74" role="button">Show Details</button>
           <img id="img" alt="nacl" style="display:none;" src="~public/bcc-packing-density.svg" >

<!-- The Modal -->
<div id="myModal" class="modal">
  <span class="close">&times;</span>
  <img class="modal-content" src="~public/bcc-packing-density.svg" id="img01">
  <div id="caption"></div>
</div>
...
import Modelslayout from '~~/layouts/modelslayout.vue';
...
let obj1;
      gltfLoader.load('/bccmain.glb',(gltf)=>{
        obj1=gltf.scene;
      //    obj1.traverse((child) => {
    ...
    //light
    const pointLight = new THREE.DirectionalLight( 0xff0000, 0.5, 100 );
const  pointLight2= new THREE.DirectionalLight( 0x0000ff, 0.5, 100 );
pointLight.position.set( 2, 5, 0 );
pointLight2.position.set( -2, -5, 0 );
